...
public class Venda {
    ...
    private CharSequence dataFinal;
    ...
    public List<Venda> getDatesBetween(String string, List<Venda> vendas, String dataInicial){
    ...
    public void getDatesBetween(ArrayList<Venda> vendas, String dtInicial, String dtFinal) {
    }
